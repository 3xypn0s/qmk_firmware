 ...
 */
    ...
    // Custom RGB Colours
    #define RGB_PALEGREEN 0x98, 0xFB, 0x98
    #define RGB_GREENYELLOW 0xAD, 0xFF, 0x2F
    #define RGB_GP_BLUE 0x00, 0x9A, 0xCD        // Glorius GPBT KeyCaps Pastel blue
    #define RGB_GP_GREEN 0x43, 0xCD, 0x80       // Glorius GPBT KeyCaps Pastel green
    #define RGB_GP_RED 0xF0, 0x61, 0x61         // Glorius GPBT KeyCaps Pastel red
    ...
    const uint8_t LED_ANSI[] = { LED_INS};

    const uint8_t LED_KEYCAPS_GPBT_PASTEL_BLUE[] = {
        LED_ESC, LED_F1,
        LED_GRV, LED_1, LED_2,
        LED_TAB, LED_Q, LED_W, LED_E, LED_R,
        LED_CAPS, LED_A, LED_S, LED_D, LED_F, LED_G, LED_H,
        LED_LSFT, LED_Z, LED_X, LED_C, LED_V, LED_B, LED_N,
        LED_LCTL, LED_LWIN, LED_LALT, LED_SPC
    };

    const uint8_t LED_KEYCAPS_GPBT_PASTEL_GREEN[] = {
        LED_F2, LED_F3, LED_F4, LED_F5, LED_F6, LED_F7, LED_F8, LED_F9,
        LED_3, LED_4, LED_5, LED_6, LED_7, LED_8, LED_9,
        LED_T, LED_Y, LED_U, LED_I, LED_O, LED_P,
        LED_J, LED_K, LED_L, LED_SCLN,
        LED_M, LED_COMM, LED_DOT, LED_SLSH,
        LED_RALT, LED_FN, LED_RCTL
    };

    const uint8_t LED_KEYCAPS_GPBT_PASTEL_RED[] = {
        LED_F8, LED_F9, LED_F10, LED_F11, LED_F12, LED_INS,
        LED_0, LED_MINS, LED_EQL, LED_BSPC, LED_DEL,
        LED_LBRC, LED_RBRC, LED_BSLS, LED_PGUP,
        LED_QUOT, LED_ENT, LED_PGDN,
        LED_RSFT, LED_UP, LED_END,
