...
#define AIAG_LBRC S(KC_8)       // (
#define AIAG_RBRC S(KC_9)       // )
#define AIAG_BSLS S(KC_7)       // Slash
...
#define MAAG_LBRC S(KC_8)       // (
#define MAAG_RBRC S(KC_9)       // )
#define MAAG_BSLS S(KC_7)       // Slash
